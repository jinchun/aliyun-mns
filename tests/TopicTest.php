...
class TopicTest extends TestCase
{
    ...
    public function testLoggingEnabled()
    {
        ...
        try {
            ...
            $this->assertTrue($res->isSucceed());
            $this->assertFalse($res->getTopicAttributes()->getLoggingEnabled());
            ...
            $res = $topic->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertTrue($res->getTopicAttributes()->getLoggingEnabled());
    ...
    public function testTopicAttributes()
    {
        ...
        try {
            $res = $topic->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertSame($topicName, $res->getTopicAttributes()->getTopicName());
        } catch (MnsException $e) {
            $this->assertTrue(false, $e);
        }
        ...
        try {
            $res = $topic->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertSame(intval($res->getTopicAttributes()->getMaximumMessageSize()), $maximumMessageSize);
        } catch (MnsException $e) {
            $this->assertTrue(false, $e);
        }
    ...
    public function testSubscribe()
    {
        ...
        try {
            ...
            $this->assertSame($e->getMnsErrorCode(), Constants::SUBSCRIPTION_ALREADY_EXIST);
        }
    ...
    public function testSubscriptionAttributes()
    {
        ...
        try {
            ...
            $this->assertTrue($res->isSucceed());
            $this->assertSame($topicName, $res->getSubscriptionAttributes()->getTopicName());
            $this->assertSame('BACKOFF_RETRY', $res->getSubscriptionAttributes()->getStrategy());
        } catch (MnsException $e) {
            $this->assertTrue(false, $e);
        }
        ...
        try {
            $res = $topic->getSubscriptionAttribute($subscriptionName);
            $this->assertTrue($res->isSucceed());
            $this->assertSame($res->getSubscriptionAttributes()->getStrategy(), $strategy);
        } catch (MnsException $e) {
            $this->assertTrue(false, $e);
        }
        ...
        try {
            ...
            $this->assertSame($e->getMnsErrorCode(), Constants::SUBSCRIPTION_NOT_EXIST);
        }
