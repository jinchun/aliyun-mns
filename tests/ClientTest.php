...
class ClientTest extends TestCase
{
    ...
    public function testAccountAttributes()
    {
        try {
            ...
            $this->assertSame('Test', $res->getAccountAttributes()->getLoggingBucket());
    ...
    public function testCreateQueueSync()
    {
        ...
        try {
            ...
            $this->assertSame($e->getMnsErrorCode(), Constants::QUEUE_ALREADY_EXIST);
        }
    }
    ...
    public function testCreateTopicSync()
    {
        ...
        try {
            ...
            $this->assertSame($e->getMnsErrorCode(), Constants::TOPIC_ALREADY_EXIST);
        }
    }
